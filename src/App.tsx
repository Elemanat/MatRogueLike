...
function App() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-(--paper-dark)">
            <div
                className="graph-paper w-95 min-h-160 max-h-[95vh] flex flex-col overflow-hidden relative border-2 border-(--ink) shadow-[6px_6px_0_var(--ink)] rounded-[4px_8px_6px_5px/6px_4px_8px_5px]"
            >
