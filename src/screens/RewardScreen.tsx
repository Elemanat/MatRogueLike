...
export const RewardScreen: React.FC<Props> = ({item, onTake, onSkip}) => (
    <div className="flex flex-col items-center justify-center h-full px-4 gap-6">
        ...
        <h2 className="text-3xl font-bold text-center text-[var(--ink)]">
            Nepřítel poražen!
        </h2>

        <p className="text-lg text-center text-[var(--ink-light)]">
            Získáváš předmět:
        </p>
        ...
        {item.name}
            ...
            <span className="text-base text-center text-[var(--ink-light)]">
        {item.description}
      </span>
        </div>
