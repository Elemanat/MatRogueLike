            ...
            <div className="flex flex-col md:flex-row gap-4 w-full max-w-[800px] mt-4 mb-2 flex-1 items-stretch justify-center">
                {offered.map(item => (
                    <button
                        ...
                        className="sketch-box flex flex-col items-center justify-center text-center px-6 py-6 cursor-pointer flex-1 w-full bg-(--paper) hover:-translate-y-2 hover:translate-x-1 hover:shadow-[0.4rem_0.4rem_0_var(--ink)] transition-all shrink-0"
                        style={{border: '0.15rem solid var(--ink)'}}
                        onClick={() => onPick(item)}
                    >
